...
class ReputationTest extends TestCase
{
    ...
    /** @test */
    public function a_user_lose_points_when_they_detele_a_thread()
    {
        $this->signIn();
    ...
    /** @test */
    public function a_user_loses_points_when_they_reply_to_a_thread_was_deleted()
    {
        $this->signIn();
    ...
    /** @test */
    public function a_user_earn_points_when_thier_reply_is_marked_as_best()
    {
        ...
        // insted of 50 we use 50 because when use add a reply it recieve 2 points see previous test.
        $total = Reputation::BEST_REPLY_AWARDED + Reputation::REPLY_POSTED;
        $this->assertEquals($total, $reply->owner->reputation);
    }

    /** @test */
    public function a_user_earn_points_when_thier_reply_is_favorited()
    {
        $this->signIn();
        $thread = create('App\Thread');
    ...
    /** @test */
    public function a_user_loses_points_when_thier_favorited_reply_is_unfavorited()
    {
        $this->signIn();
